...
class A
{
	...
	public static int getMinSpaces(String pi,ArrayList<String> nums)
	{
		...
		//this will be used to memoize the already computed subproblem
		//so that we didnt go for unnecesaary recursive calls whoch will lead to very increased time & space complexity
		HashMap<Integer,Integer> cache = new HashMap<Integer,Integer>();

		//this will be helper function , the actual recursion function
		int result = getMinSpacesHelper(pi,numsMap,cache,0);

		//if it is impossible to put any sapce anywhere the question asked to return -1
		//but our function will return INTEGER.MAX_VALUE .. so acoordingly return -1 for Integer.MAX_VALUE
